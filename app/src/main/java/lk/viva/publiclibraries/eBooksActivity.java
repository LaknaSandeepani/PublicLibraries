...
public class eBooksActivity extends AppCompatActivity {
    ...
    private void getBooksInfo(String query) {
        ...
        mRequestQueue = Volley.newRequestQueue(eBooksActivity.this);
        ...
        RequestQueue queue = Volley.newRequestQueue(eBooksActivity.this);
        ...
        JsonObjectRequest booksObjrequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < itemsArray.length(); i++) {
                        ...
                        eBookAdapter adapter = new eBookAdapter(bookInfoArrayList, eBooksActivity.this);

                        // below line is use to add linear layout
                        // manager for our recycler view.
                        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(eBooksActivity.this, RecyclerView.VERTICAL, false);
                    ...
                    Toast.makeText(eBooksActivity.this, "No Data Found" + e, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(eBooksActivity.this, "Error found is " + error, Toast.LENGTH_SHORT).show();
            }
        });
